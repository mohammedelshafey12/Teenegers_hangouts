                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                      ...
                                      Container(
                                        ...
                                        child: AutoSizeText(
                                          snapshot.hasData == false
                                              ? "User Name"
                                              : snapshot.data.documents[0][constants.username],
                                          style: TextStyle(
                                              fontFamily: 'font',
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      SizedBox(width: constrains.maxWidth * 0.02),
                                      Icon(
                                        Custom_icons.coins,
                                        color: Colors.white,
                                      ),
                                      SizedBox(width: constrains.maxWidth * 0.01),
                                      Column(
                                        mainAxisAlignment:
                                        ...
                                        children: <Widget>[
                                          ...
                                          AutoSizeText(
                                            snapshot.hasData==false?"0":"${ snapshot.data.documents[0][constants.score]}",
                                            style: TextStyle(
                                                fontFamily: 'font',
                                                color: Colors.white,
                                                fontSize: 7),
